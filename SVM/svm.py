...
def load_mnist(txt_data):
    ...
    for line in fr:
        ...
        # 数字0标记为1  其余标记为-1
        labelArr.append( 1 if int(feats[-1]) == 0 else -1)
    f.close()
...
if __name__ == '__main__':
    ...
    # trainDataList, trainLabelList = load_mnist('_Data/mnist.txt')

    # # 获取测试集及标签
    # print('start read testSet')
    # testDataList, testLabelList = load_mnist('../Mnist/mnist_test.csv')
