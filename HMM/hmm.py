...
'''
先对语料库，分词，做标注。
运用 Baum-Welch（EM）算法计算 lambda = (PI, A ,B) 确定模型 10.3
再在测试数据集上使用 Viterbi 算法预测。 10.4
'''
'''
...
def trainParameter(fileName):
    ...
    #找到对应的位置来存储
    # ord() https://www.runoob.com/python/python-func-ord.html
    B = np.zeros((4, 65536))
    #去读训练文本
...
if __name__ == '__main__':
    ...
    #依据现有训练集统计PI、A、B
    PI, A, B = trainParameter('./_Data/HMMTrainSet.txt')

    #读取测试文章
    artical = loadArticle('./_Data/testArtical.txt')
